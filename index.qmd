...
Welcome to the scoring and transaction site for the Living the Stream Bowl 2026!

Individual Sleeper league sites and League Managers, you may have to ask LMs for league "view only" access:

-   [L1](https://sleeper.com/leagues/1384249414998052864) - [\@Weagle85](https://discord.com/channels/@me/1142996811498397816)

-   [L2](https://sleeper.com/leagues/1386830574496284672) - [\@Aaron](https://discord.com/channels/@me/1143739424119726180)

-   [L3](https://sleeper.com/leagues/1386831161682038784)- [\@dereknotderrick](https://discord.com/channels/@me/1148606137432817754)

-   [L4](https://sleeper.com/leagues/1386831051346698240) - [\@apulianas](https://discord.com/channels/@me/293937564447145994)
...
df_all_transactions <- purrr::map(lts_conn, ~ ff_transactions(.x)) %>%
  ...
  mutate(
    week = difftime(timestamp, lubridate::ymd("2026-09-08"), units = "weeks") %>% ceiling(.) %>% as.integer(.) %>% if_else(. < 0L, 0L, .),
